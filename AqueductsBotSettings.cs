...
public class ConfigurationSettings
{
    ...
    [Menu("Min Segment Length", "Minimum segment length for intersection checks", 86)]
    public RangeNode<float> MinSegmentLength { get; set; } = new RangeNode<float>(1f, 0.5f, 5f);
}
